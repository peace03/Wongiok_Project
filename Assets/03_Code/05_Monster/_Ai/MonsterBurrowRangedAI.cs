...
public class MonsterBurrowRangedAI : MonsterBase
{
    ...
    private IEnumerator EmergeUpRoutine(
        Vector3 emergePosition)
    {
        Vector3 startPosition =
            transform.position;
    ...
    // 플레이어 현재 위치를 향해 공용 Bullet을 발사합니다
    ...
    // 현재 바라보는 방향을 기준으로 탄환 생성 위치를 계산합니다
